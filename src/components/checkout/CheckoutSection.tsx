    ...
    return (
      <div className="pt-40 pb-20 px-8 text-center max-w-lg mx-auto min-h-screen">
        ...
        <p className="text-neutral-500 mb-10 leading-relaxed">
          It seems you haven&apos;t added any luxury pieces to your collection
          yet.
        </p>
        <Link
          href="/collections"
      ...
      <div className="flex flex-col lg:flex-row gap-16">
        ...
        <div className="flex-1 space-y-12">
          <div className="space-y-4">
            <Link
              href="/"
              className="flex items-center gap-2 text-[10px]  tracking-widest text-neutral-400 hover:text-black transition-colors"
            >
          ...
          <form onSubmit={handleSubmit} className="space-y-10">
            ...
            <section className="space-y-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div className="space-y-2">
                  <label className="text-[10px]  tracking-widest text-neutral-500">
                    Full Name
                  </label>
                  <input
                    required
            ...
            <button
              disabled={isPending}
              type="submit"
              className="w-full bg-black text-white py-6 text-[11px]   font-bold hover:bg-neutral-800 transition-all flex items-center justify-center gap-3 disabled:bg-neutral-400"
            >
              {isPending ? (
                <>
          ...
          <div className="sticky top-32 bg-[#FAFAFA] border border-neutral-100 p-8 rounded-sm space-y-8">
            ...
            <div className="space-y-4">
              ...
              <div className="flex justify-between text-sm">
                ...
                <span className="text-[10px]  tracking-widest text-emerald-600 font-bold">
                  Complimentary
                </span>
              </div>
