  ...
  return (
    <div className="h-screen w-full flex items-center justify-center bg-[#F8F8F6] px-6">
      <div className="text-center max-w-2xl">
        ...
        >
          <span className="text-[10px]  tracking-[0.5em] text-neutral-400 mb-8 block font-bold">
            Error 404
          </span>
          ...
          <p className="text-neutral-500 mb-12 font-light leading-relaxed tracking-wide">
            The collection or page you are looking for has been moved or
            doesn&apos;t exist. Let&apos;s guide you back to our timeless
            essentials.
          </p>
          <div className="flex flex-col md:flex-row items-center justify-center gap-6">
            <Link href="/">
              <button className="bg-black text-white px-12 py-4 text-[10px]   font-bold hover:bg-neutral-800 transition-all duration-500 w-full md:w-auto">
                Return to Home
              </button>
            </Link>
            <Link href="/collections">
              <button className="border border-black/10 text-black px-12 py-4 text-[10px]   font-bold hover:bg-black hover:text-white transition-all duration-500 w-full md:w-auto">
                Explore Collections
              </button>
            </Link>
          </div>
